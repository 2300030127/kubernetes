...
Kubernetes, also known as K8s, is an open-source system for managing containerized applications across multiple hosts. It provides fundamental mechanisms for the deployment, maintenance, and scaling of applications.
...
###ACKNOWLEGEMENT:
This belongs to original owner (https://github.com/kubernetes/steering)  owners name:kubernetes
